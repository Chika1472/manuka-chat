...
st.markdown(
    ...
    .stApp {
        ...
        background-image:
            ...
            radial-gradient(circle at 50% 45%, rgba(230, 223, 216, 0.36), transparent 34rem);
        background-size:
            48px 48px,
            48px 48px,
            100% 100%,
    ...
    .st-key-composer_shell div[data-testid="stPopover"] button::before {
        content: "+";
        font-size: 22px;
        font-weight: 300;
        line-height: 1;
    ...
    .st-key-composer_shell .stTextArea [data-baseweb="textarea"] {
    ...
    .st-key-composer_shell .stTextArea [data-baseweb="textarea"] > div {
        background: transparent !important;
        border: 0 !important;
        box-shadow: none !important;
    }
    .st-key-composer_shell .stTextArea textarea {
        ...
        box-shadow: 0 12px 30px rgba(20, 20, 19, 0.06) !important;
        color: var(--ink);
        font-size: 16px;
        line-height: 1.35;
        padding: 16px 22px;
    }
    .st-key-composer_shell .stTextArea [data-baseweb="textarea"]:focus-within {
        border: 0 !important;
        box-shadow: none !important;
    }
    .st-key-composer_shell .stTextArea textarea:focus {
        ...
        box-shadow:
            ...
            0 12px 30px rgba(20, 20, 19, 0.06) !important;
    }
    .stTextInput input,
    .stNumberInput input,
    ...
    .st-key-composer_shell [data-testid="baseButton-primary"] {
        ...
        color: #ffffff;
        box-shadow: 0 12px 30px rgba(204, 120, 92, 0.22);
        font-size: 20px;
        font-weight: 600;
        padding: 0;
    }
