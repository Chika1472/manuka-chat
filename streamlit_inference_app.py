...
DEFAULT_MODEL_DIR = APP_DIR / "manuka-model-0527"
REQUIRED_PACKAGES = {
    "torch": "torch",
...
st.markdown(
    ...
    <div class="manuka-title">
        ...
        <h1>Manuka inference console</h1>
        <p>Single-turn text generation using the uploaded checkpoint and tokenizer.</p>
    </div>
    """,
    unsafe_allow_html=True,
)
